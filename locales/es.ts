export default {
  ...
  programs: {
    ...
    img_mascot_swag: "Mascota de Workout.cool",
    img_mascot_cry: "Mascota de Workout.cool triste",
    img_mascot_biceps: "Mascota de Workout.cool flexionando",
    img_mascot_woohoo: "Mascota de Workout.cool emocionada",
    img_community: "Comunidad",
    img_coach_love: "Apoyo del coach",
    img_sign_in_prompt: "Recordatorio para iniciar sesión",
    img_premium_prompt: "Contenido premium",
    img_join_cta: "Unirse al programa",
    img_level_badge: "Insignia de nivel",
    welcome_modal: {
  ...
  admin: {
    ...
    nav_dashboard_desc: "Overview of statistics",
    nav_users: "Users",
    nav_users_desc: "Manage user accounts",
    nav_programs: "Programs",
    nav_programs_desc: "Manage training programs",
    nav_quick_create: "Quick create",
    nav_quick_create_desc: "Minimal fields to create a program",
    ...
    programs_subtitle: "Create, edit, view and delete programs.",
    programs_quick_link: "Quick create",
    programs_loading: "Loading programs…",
    programs_table_program: "Program",
    programs_table_status: "Status",
    programs_table_duration: "Duration",
    programs_table_content: "Content",
    programs_table_enrollments: "Enrollments",
    programs_table_actions: "Actions",
    programs_empty_title: "No programs yet",
    programs_empty_hint: "Create your first training program to get started.",
    programs_weeks_short: "weeks",
    programs_sessions_per_week: "sessions/wk",
    programs_sessions_short: "sessions",
    programs_exercises_short: "exercises",
    programs_premium: "Premium",
    programs_free: "Free",
    programs_view_title: "View program",
    programs_manage_title: "Manage program",
    programs_this_week: "this week",
    settings_title: "Settings",
    settings_subtitle: "System configuration and operations.",
    users_title: "Users",
    users_subtitle: "Manage and maintain user accounts.",
    users_error_title: "Failed to load",
    users_error_message: "Could not load the user list. Please try again later.",
    users_error_unknown: "Unknown error",
    dashboard_title: "Admin dashboard",
    dashboard_subtitle: "Workout.cool admin",
    dashboard_community: "Community",
    dashboard_users_label: "Users",
    dashboard_sessions_label: "Workout sessions",
    dashboard_programs_label: "Programs",
    dashboard_exercises_label: "Exercises",
    dashboard_subscribers_label: "Active subscriptions",
    dashboard_week_delta: "this week",
    create_program_button: "Create program",
    quick_page_title: "Quick program setup",
    quick_page_intro:
      "Create a Program, week 1 (ProgramWeek) and session 1 (ProgramSession) on one page. Text is copied to all locales; slugs are generated automatically.",
    quick_back_list: "Programs list",
    quick_open_editor: "Full editor",
    quick_step_program: "1. Program",
    quick_step_week: "2. Week (ProgramWeek)",
    quick_step_session: "3. Session (ProgramSession)",
    quick_field_title: "Title",
    quick_field_description: "Description",
    quick_field_category: "Category",
    quick_field_image: "Cover image URL",
    quick_field_level: "Level",
    quick_field_type: "Type",
    quick_field_duration_weeks: "Duration (weeks)",
    quick_field_sessions_per_week: "Sessions per week",
    quick_field_session_minutes: "Target session length (minutes)",
    quick_field_premium: "Premium program",
    quick_placeholder_program_title: "e.g. Strength 101",
    quick_placeholder_program_desc: "Program summary",
    quick_btn_create_program: "Create program",
    quick_btn_created: "Program created",
    quick_week_title_label: "Week 1 title",
    quick_week_desc_label: "Description (optional)",
    quick_btn_add_week: "Add week 1",
    quick_btn_week_added: "Week added",
    quick_session_title_label: "Session 1 title",
    quick_session_desc_label: "Description (optional)",
    quick_session_minutes_label: "Estimated duration (minutes)",
    quick_btn_add_session: "Add session 1",
    quick_btn_adding: "Submitting…",
    quick_msg_program_created: "Program created (id: {id}). Add a week below.",
    quick_msg_week_added: "Week 1 added. You can add a session.",
    quick_msg_session_added: "Session 1 added. Open the full editor to continue.",
    quick_err_create_program_first: "Create a program first.",
    quick_err_add_week_first: "Add a week first.",
    quick_err_generic: "Something went wrong",
  ...
  bottom_navigation: {
    ...
    exercise_library_tooltip: "Explorar la biblioteca de ejercicios",
  },
  exercise_library: {
    meta_title: "Biblioteca de ejercicios",
    meta_description: "Busca ejercicios por grupo muscular, equipamiento o nombre.",
    page_title: "Biblioteca de ejercicios",
    page_subtitle: "Filtra por grupo muscular, equipamiento o nombre — claridad inspirada en iOS.",
    search_placeholder: "Buscar ejercicios, equipamiento o músculos",
    tab_all: "Todos",
    tab_chest: "Pecho",
    tab_back: "Espalda",
    tab_legs: "Piernas",
    loading: "Cargando ejercicios…",
    empty: "No hay ejercicios que coincidan con tus filtros.",
    error: "No se pudieron cargar los ejercicios.",
    detail_video: "Ver vídeo",
  },
  levels: {
  ...
  workout_builder: {
    ...
    exercise: {
      ...
      bilibili_paste_section_title: "Incrustación de Bilibili",
      bilibili_paste_section_description:
        "Pega el iframe oficial. Los usuarios conectados pueden guardar un enlace personal; los administradores también pueden actualizar el valor por defecto del catálogo.",
      bilibili_paste_placeholder: "<iframe src=\"//player.bilibili.com/player.html?...\" ...></iframe>",
      bilibili_save_mine: "Guardar en mi cuenta",
      bilibili_saving_mine: "Guardando...",
      bilibili_saved_personal: "Guardado en tu cuenta.",
      bilibili_save_global: "Guardar predeterminado para todos",
      bilibili_saving_global: "Guardando...",
      bilibili_saved_global: "Vídeo predeterminado actualizado.",
      bilibili_global_hint: "Actualizar el predeterminado no cambia a quienes ya guardaron su propio enlace de Bilibili.",
      bilibili_error: "No se pudo guardar el enlace del vídeo.",
    },
    loading: {
  ...
  ads: {
    ...
    rewarded_continue_without_ad: "Continuar sin ver el anuncio",
    rewarded_or: "o",
