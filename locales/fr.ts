export default {
  ...
  programs: {
    ...
    program_card_aria: "{title} — {level} — {programLabel}",
    img_mascot_swag: "Mascotte Workout.cool",
    img_mascot_cry: "Mascotte Workout.cool triste",
    img_mascot_biceps: "Mascotte Workout.cool qui montre ses biceps",
    img_mascot_woohoo: "Mascotte Workout.cool enthousiaste",
    img_community: "Communauté",
    img_coach_love: "Soutien coach",
    img_sign_in_prompt: "Rappel de connexion",
    img_premium_prompt: "Contenu premium",
    img_join_cta: "Rejoindre le programme",
    img_level_badge: "Badge de niveau",
    welcome_modal: {
  ...
  admin: {
    ...
    nav_dashboard_desc: "Vue d'ensemble des statistiques",
    nav_users: "Utilisateurs",
    nav_users_desc: "Gérer les comptes",
    nav_programs: "Programmes",
    nav_programs_desc: "Gérer les programmes d'entraînement",
    nav_quick_create: "Création rapide",
    nav_quick_create_desc: "Champs minimaux pour créer un programme",
    nav_settings: "Paramètres",
    nav_settings_desc: "Configuration système",
    header_brand: "Administration",
    header_profile: "Profil",
    header_logout: "Déconnexion",
    footer_title: "Workout.cool Admin",
    footer_version_label: "Version",
    programs_title: "Programmes",
    programs_subtitle: "Créer, modifier, consulter et supprimer des programmes.",
    programs_quick_link: "Création rapide",
    programs_loading: "Chargement des programmes…",
    programs_table_program: "Programme",
    programs_table_status: "Statut",
    programs_table_duration: "Durée",
    programs_table_content: "Contenu",
    programs_table_enrollments: "Inscrits",
    programs_table_actions: "Actions",
    programs_empty_title: "Aucun programme",
    programs_empty_hint: "Créez votre premier programme d'entraînement.",
    programs_weeks_short: "sem.",
    programs_sessions_per_week: "séances/sem.",
    programs_sessions_short: "séances",
    programs_exercises_short: "exercices",
    programs_premium: "Premium",
    programs_free: "Gratuit",
    programs_view_title: "Voir le programme",
    programs_manage_title: "Gérer le programme",
    programs_this_week: "cette semaine",
    settings_title: "Paramètres",
    settings_subtitle: "Configuration et administration du système.",
    users_title: "Utilisateurs",
    users_subtitle: "Gestion des comptes utilisateurs.",
    users_error_title: "Échec du chargement",
    users_error_message: "Impossible de charger la liste des utilisateurs. Réessayez plus tard.",
    users_error_unknown: "Erreur inconnue",
    dashboard_title: "Tableau de bord admin",
    dashboard_subtitle: "Admin Workout.cool",
    dashboard_community: "Communauté",
    dashboard_users_label: "Utilisateurs",
    dashboard_sessions_label: "Séances",
    dashboard_programs_label: "Programmes",
    dashboard_exercises_label: "Exercices",
    dashboard_subscribers_label: "Abonnements actifs",
    dashboard_week_delta: "cette semaine",
    create_program_button: "Créer un programme",
    quick_page_title: "Création rapide de programme",
    quick_page_intro:
      "Créez un Program, la semaine 1 (ProgramWeek) et la séance 1 (ProgramSession) sur une page. Le texte est copié dans toutes les langues ; les slugs sont générés automatiquement.",
    quick_back_list: "Liste des programmes",
    quick_open_editor: "Éditeur complet",
    quick_step_program: "1. Program",
    quick_step_week: "2. Semaine (ProgramWeek)",
    quick_step_session: "3. Séance (ProgramSession)",
    quick_field_title: "Titre",
    quick_field_description: "Description",
    quick_field_category: "Catégorie",
    quick_field_image: "URL de l'image de couverture",
    quick_field_level: "Niveau",
    quick_field_type: "Type",
    quick_field_duration_weeks: "Durée (semaines)",
    quick_field_sessions_per_week: "Séances par semaine",
    quick_field_session_minutes: "Durée cible d'une séance (minutes)",
    quick_field_premium: "Programme premium",
    quick_placeholder_program_title: "ex. Force 101",
    quick_placeholder_program_desc: "Résumé du programme",
    quick_btn_create_program: "Créer le programme",
    quick_btn_created: "Programme créé",
    quick_week_title_label: "Titre de la semaine 1",
    quick_week_desc_label: "Description (optionnel)",
    quick_btn_add_week: "Ajouter la semaine 1",
    quick_btn_week_added: "Semaine ajoutée",
    quick_session_title_label: "Titre de la séance 1",
    quick_session_desc_label: "Description (optionnel)",
    quick_session_minutes_label: "Durée estimée (minutes)",
    quick_btn_add_session: "Ajouter la séance 1",
    quick_btn_adding: "Envoi…",
    quick_msg_program_created: "Programme créé (id : {id}). Ajoutez une semaine ci-dessous.",
    quick_msg_week_added: "Semaine 1 ajoutée. Vous pouvez ajouter une séance.",
    quick_msg_session_added: "Séance 1 ajoutée. Ouvrez l'éditeur complet pour continuer.",
    quick_err_create_program_first: "Créez d'abord un programme.",
    quick_err_add_week_first: "Ajoutez d'abord une semaine.",
    quick_err_generic: "Une erreur s'est produite",
    ...
    program_builder: {
      ...
      err_add_exercise: "Could not add exercise",
      err_add_session: "Could not add session",
      err_add_week: "Could not add week",
      err_create_program: "Could not create program",
      err_delete_program: "Could not delete program",
      err_save_program: "Could not save program",
      err_save_week: "Could not save week",
      err_update_session: "Could not update session",
      err_update_sets: "Could not save sets",
      err_visibility: "Could not update visibility",
      visibility_draft: "Draft",
      visibility_published: "Published",
      visibility_archived: "Archived",
      delete_confirm_title: "Confirm deletion",
      delete_confirm_intro: "Delete program “{title}”? This cannot be undone.",
      delete_confirm_warning: "All weeks, sessions, and exercises linked to this program will be removed.",
      create_modal_title: "Create a new program",
      create_step1_title: "General information",
      create_step1_desc: "Title, description, level…",
      create_step2_title: "Configuration",
      create_step2_desc: "Duration, frequency, equipment…",
      create_step3_title: "Coaches",
      create_step3_desc: "Add program coaches",
      create_form_step1_heading: "General information",
      create_form_step2_heading: "Program configuration",
      create_form_step3_heading: "Program coaches",
      create_form_category: "Category",
      create_form_category_ph: "e.g. Strength",
      create_form_image_url: "Image URL",
      create_form_image_ph: "https://…",
      create_form_level: "Level",
      create_form_type: "Type",
      create_form_duration_weeks: "Duration (weeks)",
      create_form_sessions_per_week: "Sessions / week",
      create_form_session_minutes: "Session length (min)",
      create_form_equipment: "Required equipment",
      create_form_premium_program: "Premium program",
      create_form_coaches_empty: "No coach added. Click “Add” to start.",
      create_form_coach_name: "Name",
      create_form_coach_name_ph: "Coach name",
      create_form_coach_image: "Image URL",
      create_form_submit_creating: "Creating…",
      create_form_submit_create: "Create program",
      add_exercise_title: "Add exercise",
      add_exercise_pick_title: "Choose an exercise",
      add_exercise_search_ph: "Search exercises…",
      add_exercise_select: "Select",
      add_exercise_instructions_heading: "Instructions",
      add_exercise_instructions_fr: "Instructions (FR)",
      add_exercise_instructions_en: "Instructions (EN)",
      add_exercise_instructions_fr_ph: "Instructions for this exercise in this program…",
      add_exercise_instructions_en_ph: "English instructions for this exercise…",
      add_exercise_suggested_sets: "Suggested sets",
      add_exercise_tpl_strength: "Strength",
      add_exercise_tpl_bodyweight: "Bodyweight",
      add_exercise_tpl_timed: "Timed",
      add_exercise_add_set: "Add set",
      add_exercise_type: "Type",
      add_exercise_type_select: "Select",
      add_exercise_type_weight_reps: "Weight + reps",
      add_exercise_type_reps: "Reps only",
      add_exercise_type_time: "Time",
      add_exercise_type_bodyweight: "Bodyweight",
      add_exercise_weight: "Weight",
      add_exercise_ph_kg: "kg",
      add_exercise_reps: "Reps",
      add_exercise_time_sec: "Time (sec)",
      add_exercise_unit: "Unit",
      add_exercise_ph_reps: "reps",
      add_exercise_ph_seconds: "seconds",
      add_exercise_empty_sets: "No sets configured",
      add_exercise_add_first_set: "Add first set",
      add_exercise_submit: "Add exercise",
      add_exercise_submitting: "Adding…",
      session_modal_add_title: "Add session",
      session_modal_edit_title: "Edit session",
      session_estimated_minutes: "Estimated duration (minutes)",
      session_premium_label: "Premium session",
      session_equipment_label: "Required equipment",
      session_submit_add: "Add session",
      session_submit_edit: "Update session",
      session_submit_adding: "Adding…",
      session_submit_updating: "Updating…",
      week_modal_add_title: "Add week",
      week_modal_edit_title: "Edit week {n}",
      week_submit_add: "Add week",
      week_submit_adding: "Adding…",
      week_submit_save: "Save",
      week_submit_saving: "Saving…",
      program_modal_edit_title: "Edit program",
      program_image_url: "Image URL",
      program_category: "Category",
      program_equipment_label: "Required equipment",
      program_premium_label: "Premium program",
      program_coaches_heading: "Program coaches",
      program_builder_back: "Back to programs",
      program_builder_participants: "Participants",
      program_builder_weeks_heading: "Weeks ({current}/{total})",
      program_builder_add_week: "Add week",
      program_builder_no_weeks_title: "No weeks yet",
      program_builder_no_weeks_desc: "Start by adding the first week of your program.",
      program_builder_add_first_week: "Add first week",
      program_builder_coaches_title: "Coaches ({count})",
      program_builder_edit_coaches: "Edit coaches",
      program_builder_edit_program: "Edit program",
      program_builder_no_coach_title: "No coach assigned",
      program_builder_no_coach_desc: "Add coaches to highlight experts guiding users.",
      program_builder_add_coach: "Add coach",
      program_builder_coach_order: "Coach #{n}",
      program_builder_stats_weeks: "{n} weeks",
      program_builder_stats_min_per_session: "{n} min / session",
      program_builder_stats_sessions_per_week: "{n} sessions / week",
      program_builder_equipment_prefix: "Equipment:",
      program_builder_equipment_none: "None",
      program_builder_analytics_title: "Statistics",
      program_builder_analytics_placeholder: "Program analytics (to be implemented)",
      week_card_week_title: "Week {n}: {title}",
      week_card_sessions_badge: "{count} session(s)",
      week_card_edit_week: "Edit week",
      week_card_add_session: "Session",
      week_card_no_sessions: "No sessions in this week",
      week_card_add_first_session: "Add first session",
      session_card_edit_session: "Edit session",
      session_card_add_exercise: "Exercise",
      session_card_no_exercises: "No exercises in this session",
      session_card_add_first_exercise: "Add first exercise",
      session_card_edit_sets: "Edit sets",
      session_card_sets_line: "{count} set(s)",
      session_card_min_suffix: "min",
      sets_modal_title: "Edit sets — {name}",
      sets_modal_set_badge: "SET {n}",
      sets_modal_add_column: "Add column",
      sets_modal_add_set: "Add set",
      sets_modal_type_time: "Time",
      sets_modal_type_weight: "Weight",
      sets_modal_type_reps: "Reps",
      sets_modal_type_bodyweight: "Bodyweight",
      sets_modal_type_na: "N/A",
      sets_modal_ph_min: "min",
      sets_modal_ph_sec: "sec",
      edit_sets_placeholder_min: "min",
      edit_sets_placeholder_sec: "sec",
      tab_fr: "🇫🇷 FR",
      tab_en: "🇺🇸 EN",
      tab_es: "🇪🇸 ES",
      tab_pt: "🇵🇹 PT",
      tab_ru: "🇷🇺 RU",
      tab_zh: "🇨🇳 ZH",
      label_title_fr: "Title (French)",
      label_description_fr: "Description (French)",
      label_title_en: "Title (English)",
      label_description_en: "Description (English)",
      label_title_es: "Title (Spanish)",
      label_description_es: "Description (Spanish)",
      label_title_pt: "Title (Portuguese)",
      label_description_pt: "Description (Portuguese)",
      label_title_ru: "Title (Russian)",
      label_description_ru: "Description (Russian)",
      label_title_zh: "Title (Chinese)",
      label_description_zh: "Description (Chinese)",
      ph_session_title_fr: "Session title",
      ph_session_desc_fr: "Session description…",
      ph_session_title_en: "Session title",
      ph_session_desc_en: "Session description…",
      ph_session_title_es: "Session title",
      ph_session_desc_es: "Session description…",
      ph_session_title_pt: "Session title",
      ph_session_desc_pt: "Session description…",
      ph_session_title_ru: "Session title",
      ph_session_desc_ru: "Session description…",
      ph_session_title_zh: "Session title",
      ph_session_desc_zh: "Session description…",
      default_session_title_fr: "Session {n}",
      default_session_title_en: "Session {n}",
      default_session_title_es: "Session {n}",
      default_session_title_pt: "Session {n}",
      default_session_title_ru: "Session {n}",
      default_session_title_zh: "第{n}节",
      default_session_desc_fr: "Session {n} description",
      default_session_desc_en: "Session {n} description",
      default_session_desc_es: "Session {n} description",
      default_session_desc_pt: "Session {n} description",
      default_session_desc_ru: "Session {n} description",
      default_session_desc_zh: "第{n}节课程描述",
      default_week_title_fr: "Week {n}",
      default_week_title_en: "Week {n}",
      default_week_title_es: "Week {n}",
      default_week_title_pt: "Week {n}",
      default_week_title_ru: "Week {n}",
      default_week_title_zh: "Week {n}",
      ph_week_title_fr: "Week title",
      ph_week_desc_fr: "Week description…",
      ph_week_title_en: "Week title",
      ph_week_desc_en: "Week description…",
      ph_week_title_es: "Week title",
      ph_week_desc_es: "Week description…",
      ph_week_title_pt: "Week title",
      ph_week_desc_pt: "Week description…",
      ph_week_title_ru: "Week title",
      ph_week_desc_ru: "Week description…",
      ph_week_title_zh: "Week title",
      ph_week_desc_zh: "Week description…",
      level_beginner: "Beginner",
      level_intermediate: "Intermediate",
      level_advanced: "Advanced",
      level_expert: "Expert",
      exercises_count: "{count} exercise(s)",
      validation_select_exercise: "Select an exercise",
      validation_instructions_fr: "Instructions are required",
      validation_instructions_en: "English instructions are required",
      validation_title_fr: "Title is required",
      validation_title_en: "English title is required",
      validation_title_es: "Spanish title is required",
      validation_title_pt: "Portuguese title is required",
      validation_title_ru: "Russian title is required",
      validation_title_zh: "Chinese title is required",
      validation_description_fr: "Description is required",
      validation_description_en: "English description is required",
      validation_description_es: "Spanish description is required",
      validation_description_pt: "Portuguese description is required",
      validation_description_ru: "Russian description is required",
      validation_description_zh: "Chinese description is required",
      validation_minutes_min: "At least 5 minutes",
      validation_category: "Category is required",
      validation_image_url: "Invalid image URL",
      validation_coach_name: "Name is required",
      validation_coach_image: "Invalid image URL",
      validation_duration_weeks: "At least 1 week",
      validation_sessions_per_week: "At least 1 session per week",
      validation_session_duration: "At least 5 minutes",
    },  },
  bottom_navigation: {
    ...
    exercise_library: "Bibliothèque",
    exercise_library_tooltip: "Parcourir la bibliothèque d'exercices",
  },
  exercise_library: {
    meta_title: "Bibliothèque d'exercices",
    meta_description: "Recherchez des exercices par groupe musculaire, équipement ou nom.",
    page_title: "Bibliothèque d'exercices",
    page_subtitle: "Filtrez par groupe musculaire, équipement ou nom — interface claire inspirée d'iOS.",
    search_placeholder: "Rechercher exercices, équipement ou muscles",
    tab_all: "Tous",
    tab_chest: "Pectoraux",
    tab_back: "Dos",
    tab_legs: "Jambes",
    loading: "Chargement des exercices…",
    empty: "Aucun exercice ne correspond à ces filtres.",
    error: "Impossible de charger les exercices.",
    detail_video: "Voir la vidéo",
  },
  tools: {
  ...
  workout_builder: {
    ...
    exercise: {
      ...
      bilibili_paste_section_title: "Intégration Bilibili",
      bilibili_paste_section_description:
        "Collez le snippet iframe officiel. Les utilisateurs connectés peuvent enregistrer un lien personnel ; les admins peuvent aussi mettre à jour la valeur par défaut du catalogue.",
      bilibili_paste_placeholder: "<iframe src=\"//player.bilibili.com/player.html?...\" ...></iframe>",
      bilibili_save_mine: "Enregistrer sur mon compte",
      bilibili_saving_mine: "Enregistrement...",
      bilibili_saved_personal: "Enregistré sur votre compte.",
      bilibili_save_global: "Définir la valeur par défaut",
      bilibili_saving_global: "Enregistrement...",
      bilibili_saved_global: "Vidéo par défaut mise à jour.",
      bilibili_global_hint:
        "La mise à jour par défaut n’affecte pas les utilisateurs qui ont déjà enregistré leur propre lien Bilibili pour cet exercice.",
      bilibili_error: "Impossible d’enregistrer le lien vidéo.",
    },
    loading: {
  ...
  ads: {
    ...
    rewarded_continue_without_ad: "Continuer sans regarder la pub",
    rewarded_or: "ou",
