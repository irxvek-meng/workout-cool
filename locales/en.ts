export default {
  ...
  programs: {
    ...
    img_mascot_swag: "Workout.cool mascot",
    img_mascot_cry: "Workout.cool mascot looking sad",
    img_mascot_biceps: "Workout.cool mascot flexing",
    img_mascot_woohoo: "Workout.cool mascot excited",
    img_community: "Community",
    img_coach_love: "Coach appreciation",
    img_sign_in_prompt: "Sign in reminder",
    img_premium_prompt: "Premium content",
    img_join_cta: "Join the workout program",
    img_level_badge: "Level badge decoration",
    welcome_modal: {
  ...
  bottom_navigation: {
    ...
    exercise_library_tooltip: "Browse the exercise library",
  },
  exercise_library: {
    meta_title: "Exercise library",
    meta_description: "Search exercises by muscle group, equipment, or name.",
    page_title: "Exercise Library",
    page_subtitle: "Filter by muscle group, equipment, or name — inspired by iOS clarity.",
    search_placeholder: "Search exercises, equipment, or muscles",
    tab_all: "All",
    tab_chest: "Chest",
    tab_back: "Back",
    tab_legs: "Legs",
  ...
  workout_builder: {
    ...
    exercise: {
      ...
      bilibili_paste_section_title: "Bilibili embed",
      bilibili_paste_section_description:
        "Paste the official iframe snippet. Logged-in users can save a personal link; admins can also update the catalog default for users who have not set their own.",
      bilibili_paste_placeholder: "<iframe src=\"//player.bilibili.com/player.html?...\" ...></iframe>",
      bilibili_save_mine: "Save to my account",
      bilibili_saving_mine: "Saving...",
      bilibili_saved_personal: "Saved to your account.",
      bilibili_save_global: "Save default for everyone",
      bilibili_saving_global: "Saving...",
      bilibili_saved_global: "Default video updated.",
      bilibili_global_hint:
        "Updating the default does not change users who already saved their own Bilibili link for this exercise.",
      bilibili_error: "Could not save the video link.",
    },
    loading: {
  ...
  ads: {
    ...
    rewarded_continue_without_ad: "Continue without watching",
    rewarded_or: "or",
