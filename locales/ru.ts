export default {
  ...
  programs: {
    ...
    img_mascot_swag: "Талисман Workout.cool",
    img_mascot_cry: "Талисман Workout.cool грустный",
    img_mascot_biceps: "Талисман Workout.cool с бицепсом",
    img_mascot_woohoo: "Талисман Workout.cool в восторге",
    img_community: "Сообщество",
    img_coach_love: "Поддержка тренера",
    img_sign_in_prompt: "Напоминание войти",
    img_premium_prompt: "Премиум-контент",
    img_join_cta: "Присоединиться к программе",
    img_level_badge: "Значок уровня",
    welcome_modal: {
  ...
  bottom_navigation: {
    ...
    exercise_library: "Упражнения",
    exercise_library_tooltip: "Каталог упражнений",
  },
  exercise_library: {
    meta_title: "Библиотека упражнений",
    meta_description: "Ищите упражнения по группе мышц, оборудованию или названию.",
    page_title: "Библиотека упражнений",
    page_subtitle: "Фильтруйте по группе мышц, оборудованию или названию — ясный интерфейс в духе iOS.",
    search_placeholder: "Поиск упражнений, оборудования или мышц",
    tab_all: "Все",
    tab_chest: "Грудь",
    tab_back: "Спина",
    tab_legs: "Ноги",
    loading: "Загрузка упражнений…",
    empty: "Нет упражнений по выбранным фильтрам.",
    error: "Не удалось загрузить упражнения.",
    detail_video: "Смотреть видео",
  },
  tools: {
  ...
  admin: {
    ...
    nav_dashboard_desc: "Сводная статистика",
    nav_users: "Пользователи",
    nav_users_desc: "Управление аккаунтами",
    nav_programs: "Программы",
    nav_programs_desc: "Управление программами тренировок",
    nav_quick_create: "Быстрое создание",
    nav_quick_create_desc: "Минимум полей для программы",
    nav_settings: "Настройки",
    nav_settings_desc: "Конфигурация системы",
    header_brand: "Админ-панель",
    header_profile: "Профиль",
    header_logout: "Выйти",
    footer_title: "Workout.cool — админка",
    footer_version_label: "Версия",
    programs_title: "Программы",
    programs_subtitle: "Создание, редактирование и удаление программ.",
    programs_quick_link: "Быстрое создание",
    programs_loading: "Загрузка программ…",
    programs_table_program: "Программа",
    programs_table_status: "Статус",
    programs_table_duration: "Длительность",
    programs_table_content: "Содержимое",
    programs_table_enrollments: "Записи",
    programs_table_actions: "Действия",
    programs_empty_title: "Пока нет программ",
    programs_empty_hint: "Создайте первую программу тренировок.",
    programs_weeks_short: "нед",
    programs_sessions_per_week: "зан/нед",
    programs_sessions_short: "занятий",
    programs_exercises_short: "упражнений",
    programs_premium: "Премиум",
    programs_free: "Бесплатно",
    programs_view_title: "Открыть программу",
    programs_manage_title: "Управлять программой",
    programs_this_week: "за неделю",
    settings_title: "Настройки",
    settings_subtitle: "Параметры системы и администрирование.",
    users_title: "Пользователи",
    users_subtitle: "Управление пользовательскими аккаунтами.",
    users_error_title: "Ошибка загрузки",
    users_error_message: "Не удалось загрузить список пользователей. Попробуйте позже.",
    users_error_unknown: "Неизвестная ошибка",
    dashboard_title: "Админ-панель",
    dashboard_subtitle: "Workout.cool — админка",
    dashboard_community: "Сообщество",
    dashboard_users_label: "Пользователи",
    dashboard_sessions_label: "Тренировки",
    dashboard_programs_label: "Программы",
    dashboard_exercises_label: "Упражнения",
    dashboard_subscribers_label: "Подписки",
    dashboard_week_delta: "за неделю",
    create_program_button: "Создать программу",
    quick_page_title: "Быстрое создание программы",
    quick_page_intro:
      "Одна страница: Program, неделя 1 (ProgramWeek) и занятие 1 (ProgramSession). Текст копируется на все локали; slug генерируется автоматически.",
    quick_back_list: "Список программ",
    quick_open_editor: "Полный редактор",
    quick_step_program: "1. Программа (Program)",
    quick_step_week: "2. Неделя (ProgramWeek)",
    quick_step_session: "3. Занятие (ProgramSession)",
    quick_field_title: "Название",
    quick_field_description: "Описание",
    quick_field_category: "Категория",
    quick_field_image: "URL обложки",
    quick_field_level: "Уровень",
    quick_field_type: "Тип",
    quick_field_duration_weeks: "Длительность (недели)",
    quick_field_sessions_per_week: "Занятий в неделю",
    quick_field_session_minutes: "Целевая длительность занятия (мин)",
    quick_field_premium: "Премиум-программа",
    quick_placeholder_program_title: "Например: Сила 101",
    quick_placeholder_program_desc: "Краткое описание программы",
    quick_btn_create_program: "Создать программу",
    quick_btn_created: "Программа создана",
    quick_week_title_label: "Название недели 1",
    quick_week_desc_label: "Описание (необязательно)",
    quick_btn_add_week: "Добавить неделю 1",
    quick_btn_week_added: "Неделя добавлена",
    quick_session_title_label: "Название занятия 1",
    quick_session_desc_label: "Описание (необязательно)",
    quick_session_minutes_label: "Оценка длительности (мин)",
    quick_btn_add_session: "Добавить занятие 1",
    quick_btn_adding: "Отправка…",
    quick_msg_program_created: "Программа создана (id: {id}). Добавьте неделю ниже.",
    quick_msg_week_added: "Неделя 1 добавлена. Можно добавить занятие.",
    quick_msg_session_added: "Занятие 1 добавлено. Откройте полный редактор, чтобы продолжить.",
    quick_err_create_program_first: "Сначала создайте программу.",
    quick_err_add_week_first: "Сначала добавьте неделю.",
    quick_err_generic: "Что-то пошло не так",
  ...
  workout_builder: {
    ...
    exercise: {
      ...
      bilibili_paste_section_title: "Встраивание Bilibili",
      bilibili_paste_section_description:
        "Вставьте официальный iframe. Вошедшие пользователи могут сохранить личную ссылку; администраторы также могут обновить значение по умолчанию в каталоге.",
      bilibili_paste_placeholder: "<iframe src=\"//player.bilibili.com/player.html?...\" ...></iframe>",
      bilibili_save_mine: "Сохранить в мой аккаунт",
      bilibili_saving_mine: "Сохранение...",
      bilibili_saved_personal: "Сохранено в вашем аккаунте.",
      bilibili_save_global: "Сохранить по умолчанию для всех",
      bilibili_saving_global: "Сохранение...",
      bilibili_saved_global: "Видео по умолчанию обновлено.",
      bilibili_global_hint: "Обновление по умолчанию не затрагивает пользователей, которые уже сохранили свой Bilibili-ссылку.",
      bilibili_error: "Не удалось сохранить ссылку на видео.",
    },
    loading: {
  ...
  ads: {
    ...
    rewarded_continue_without_ad: "Продолжить без просмотра рекламы",
    rewarded_or: "или",
