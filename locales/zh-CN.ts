export default {
  ...
  programs: {
    ...
    img_mascot_swag: "Workout.cool 吉祥物",
    img_mascot_cry: "Workout.cool 吉祥物（难过）",
    img_mascot_biceps: "Workout.cool 吉祥物（展示肌肉）",
    img_mascot_woohoo: "Workout.cool 吉祥物（期待）",
    img_community: "社区",
    img_coach_love: "教练祝福",
    img_sign_in_prompt: "请先登录",
    img_premium_prompt: "高级版内容",
    img_join_cta: "加入训练计划",
    img_level_badge: "等级标识装饰",
    welcome_modal: {
  ...
  admin: {
    nav_section: "导航",
    nav_dashboard: "控制台",
    nav_dashboard_desc: "数据统计总览",
    nav_users: "用户",
    nav_users_desc: "管理用户账号",
    nav_programs: "课程",
    nav_programs_desc: "管理训练课程",
    nav_quick_create: "快速创建",
    nav_quick_create_desc: "最少字段创建课程",
    nav_settings: "设置",
    nav_settings_desc: "系统配置",
    header_brand: "管理后台",
    header_profile: "个人资料",
    header_logout: "退出登录",
    footer_title: "Workout.cool 管理后台",
    footer_version_label: "版本",
    programs_title: "课程",
    programs_subtitle: "创建、编辑、查看和删除课程。",
    programs_quick_link: "快速创建",
    programs_loading: "正在加载课程…",
    programs_table_program: "课程",
    programs_table_status: "状态",
    programs_table_duration: "周期",
    programs_table_content: "内容",
    programs_table_enrollments: "报名",
    programs_table_actions: "操作",
    programs_empty_title: "暂无课程",
    programs_empty_hint: "请先创建你的第一个训练课程。",
    programs_weeks_short: "周",
    programs_sessions_per_week: "次/周",
    programs_sessions_short: "次课",
    programs_exercises_short: "个动作",
    programs_premium: "付费",
    programs_free: "免费",
    programs_view_title: "查看课程",
    programs_manage_title: "管理课程",
    programs_this_week: "本周",
    settings_title: "设置",
    settings_subtitle: "系统参数与运维配置。",
    users_title: "用户",
    users_subtitle: "管理与维护用户账号。",
    users_error_title: "加载失败",
    users_error_message: "无法加载用户列表，请稍后重试。",
    users_error_unknown: "未知错误",
    dashboard_title: "管理控制台",
    dashboard_subtitle: "Workout.cool 管理端",
    dashboard_community: "社区",
    dashboard_users_label: "用户",
    dashboard_sessions_label: "训练次数",
    dashboard_programs_label: "课程",
    dashboard_exercises_label: "动作",
    dashboard_subscribers_label: "订阅中",
    dashboard_week_delta: "本周新增",
    create_program_button: "创建课程",
    quick_page_title: "快速创建课程",
    quick_page_intro:
      "单页创建 Program、第 1 周 ProgramWeek 与第 1 节 ProgramSession。文案会复制到各语言；slug 自动生成。",
    quick_back_list: "课程列表",
    quick_open_editor: "完整编辑器",
    quick_step_program: "1. 课程（Program）",
    quick_step_week: "2. 周（ProgramWeek）",
    quick_step_session: "3. 课（ProgramSession）",
    quick_field_title: "标题",
    quick_field_description: "描述",
    quick_field_category: "分类",
    quick_field_image: "封面图 URL",
    quick_field_level: "难度",
    quick_field_type: "类型",
    quick_field_duration_weeks: "持续周数",
    quick_field_sessions_per_week: "每周训练次数",
    quick_field_session_minutes: "单次目标时长（分钟）",
    quick_field_premium: "付费课程",
    quick_placeholder_program_title: "例如：力量入门 101",
    quick_placeholder_program_desc: "课程简介",
    quick_btn_create_program: "创建课程",
    quick_btn_created: "已创建课程",
    quick_week_title_label: "第 1 周标题",
    quick_week_desc_label: "描述（可选）",
    quick_btn_add_week: "添加第 1 周",
    quick_btn_week_added: "已添加周",
    quick_session_title_label: "第 1 课标题",
    quick_session_desc_label: "描述（可选）",
    quick_session_minutes_label: "预计时长（分钟）",
    quick_btn_add_session: "添加第 1 课",
    quick_btn_adding: "提交中…",
    quick_msg_program_created: "课程已创建（id: {id}）。请继续添加周。",
    quick_msg_week_added: "第 1 周已添加，可添加课程。",
    quick_msg_session_added: "第 1 课已添加。可打开完整编辑器继续编辑。",
    quick_err_create_program_first: "请先创建课程。",
    quick_err_add_week_first: "请先添加周。",
    quick_err_generic: "操作失败",
  ...
  bottom_navigation: {
    ...
    exercise_library_tooltip: "浏览动作库",
  },
  exercise_library: {
    meta_title: "动作库",
    meta_description: "按肌群、器械或名称搜索训练动作。",
    page_title: "动作库",
    page_subtitle: "按肌群、器械或名称快速查找，界面灵感来自 iOS 的简洁与层次。",
    search_placeholder: "搜索动作、器械或肌群",
    tab_all: "全部",
    tab_chest: "胸部",
    tab_back: "背部",
    tab_legs: "腿部",
  ...
  workout_builder: {
    ...
    exercise: {
      ...
      bilibili_paste_section_title: "哔哩哔哩嵌入",
      bilibili_paste_section_description: "粘贴官方 iframe 代码。登录用户可保存个人链接；管理员还可更新目录默认（未设置个人链接的用户会生效）。",
      bilibili_paste_placeholder: "<iframe src=\"//player.bilibili.com/player.html?...\" ...></iframe>",
      bilibili_save_mine: "保存到我的账户",
      bilibili_saving_mine: "保存中…",
      bilibili_saved_personal: "已保存到你的账户。",
      bilibili_save_global: "保存为全员默认",
      bilibili_saving_global: "保存中…",
      bilibili_saved_global: "默认视频已更新。",
      bilibili_global_hint: "更新默认不会影响已为该动作保存个人哔哩哔哩链接的用户。",
      bilibili_error: "保存视频链接失败。",
    },
    loading: {
      exercises: "正在加载练习...",
    },
  ...
  ads: {
    ...
    rewarded_continue_without_ad: "暂不观看，直接开始",
    rewarded_or: "或",
