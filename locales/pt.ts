...
export default {
  ...
  programs: {
    ...
    img_mascot_swag: "Mascote Workout.cool",
    img_mascot_cry: "Mascote Workout.cool triste",
    img_mascot_biceps: "Mascote Workout.cool a mostrar bíceps",
    img_mascot_woohoo: "Mascote Workout.cool entusiasmado",
    img_community: "Comunidade",
    img_coach_love: "Apoio do coach",
    img_sign_in_prompt: "Lembrete para iniciar sessão",
    img_premium_prompt: "Conteúdo premium",
    img_join_cta: "Aderir ao programa",
    img_level_badge: "Distintivo de nível",
    welcome_modal: {
  ...
  bottom_navigation: {
    ...
    exercise_library_tooltip: "Explorar a biblioteca de exercícios",
  },
  exercise_library: {
    meta_title: "Biblioteca de exercícios",
    meta_description: "Pesquise exercícios por grupo muscular, equipamento ou nome.",
    page_title: "Biblioteca de exercícios",
    page_subtitle: "Filtre por grupo muscular, equipamento ou nome — clareza inspirada no iOS.",
    search_placeholder: "Pesquisar exercícios, equipamento ou músculos",
    tab_all: "Todos",
    tab_chest: "Peito",
    tab_back: "Costas",
    tab_legs: "Pernas",
    loading: "A carregar exercícios…",
    empty: "Nenhum exercício corresponde aos filtros.",
  ...
  workout_builder: {
    ...
    exercise: {
      ...
      bilibili_paste_section_title: "Incorporação Bilibili",
      bilibili_paste_section_description:
        "Cole o iframe oficial. Utilizadores com sessão iniciada podem guardar um link pessoal; administradores também podem atualizar o padrão do catálogo.",
      bilibili_paste_placeholder: "<iframe src=\"//player.bilibili.com/player.html?...\" ...></iframe>",
      bilibili_save_mine: "Guardar na minha conta",
      bilibili_saving_mine: "A guardar...",
      bilibili_saved_personal: "Guardado na sua conta.",
      bilibili_save_global: "Guardar padrão para todos",
      bilibili_saving_global: "A guardar...",
      bilibili_saved_global: "Vídeo padrão atualizado.",
      bilibili_global_hint: "Atualizar o padrão não altera quem já guardou o seu próprio link do Bilibili.",
      bilibili_error: "Não foi possível guardar a ligação do vídeo.",
    },
    loading: {
  ...
  ads: {
    ...
    rewarded_continue_without_ad: "Continuar sem ver o anúncio",
    rewarded_or: "ou",
